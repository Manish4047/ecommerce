        ...
        <div class="row">
            <div class="col-md-6  mt-5 m-auto bg-white shadow font-monospace border border-info">
                ...
                <form action="insert.php" method="POST">
                    ...
                    <input type="email" name="email" class="mb-3" placeholder="enter user email" class="form-control">
                    </div>
                    <div class="mb-3">
                    <label for="">Usernumber</label>
                    <input type="number" name="number" class="mb-3" placeholder="enter user number" class="form-control">
                    </div>
                    <div class="mb-3">
